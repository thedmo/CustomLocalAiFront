...
- Ändern ausserhalb des Umfangs der Karte: andere Komponenten, andere Schichten, `docker_compose.yml`, `appsettings*.json`, `.csproj`, `global.json`, ausser die Karte nennt die Datei.
