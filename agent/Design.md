...
| ---------------------------------------- | -------- | --------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| NeueUnterhaltung()                       | F03      | keine                                         | Reservierte Kennung eines noch ungespeicherten Entwurfs                                                                                            |
...
Präzisierung F03 durch PS am 24.09.2026: Die Chat-Seite lädt beim Seitenstart die gespeicherte Liste, hält die leere Eingabe aber nur als lokalen Entwurf. Auch „Neue Unterhaltung“ erzeugt zunächst keinen Listeneintrag und keinen Datenbankdatensatz. Erst beim Senden der ersten Nachricht reserviert der ChatService eine Kennung und speichert Unterhaltung und erste Nachricht gemeinsam in einer Store-Operation; danach erscheint sie sofort in der Liste. Scheitert diese Speicherung oder endet der Prozess davor, bleibt kein leerer Datenbankdatensatz zurück. Prerendering bleibt für die Chat-Seite deaktiviert. Der Backend-Verlauf ist die Quelle für jedes Öffnen. Diese freigegebenen Präzisierungen sind durch die Gruppe in das Masterkonzept, Kapitel 7/9 und Änderungsnachweis 14.3, zu übernehmen.

Kennung: jede Unterhaltung, Nachricht und Antwort erhält beim Anlegen eine GUID. Der lokale Entwurf hat noch keine fachliche Kennung. Mit der ersten Nachricht wird die Unterhaltung angelegt und deren Anfang als Titel verwendet; im normalen Seitenablauf neu gespeicherte Unterhaltungen enthalten deshalb mindestens eine Nachricht. Bereits vorhandene leere Unterhaltungen bleiben lesbar. Der Titel kann geändert werden. Löschung: F05 entfernt die Unterhaltung mit allen Nachrichten und Antworten (Kaskade); der technische Protokolleintrag bleibt, weil er keinen Chattext enthält. Neustart: die SQLite-Datei bleibt im Volume, die Liste wird beim Start geladen; eine Antwort, die beim Neustart noch lief, wird als Gestört mit Grund Neustart gespeichert. Öffnen, Löschen und Wiederherstellen der Unterhaltungen erfolgen ausschliesslich über ChatService und Store und benötigen keinen erreichbaren Modellserver.
...
| F03, F04, F05 / Z05 | Chat-Seite, ChatService und SQLite-Store: Entwurf erst mit erster Nachricht speichern, Verläufe nach Neustart öffnen, vollständig und einzeln löschen                                                           |
...
- Persistenz: Seite und leeren Entwurf ohne Datenbankeintrag öffnen, mit erster Nachricht eine Unterhaltung anlegen, fünf Unterhaltungen speichern, Anwendung neu starten, alle öffnen und eine vollständig löschen; laufende Zustände nach Neustart als Gestört markieren (T01, T05, T06, Z05).
