...
| Microsoft.EntityFrameworkCore.Sqlite | SQLite-Datenhaltung, AP09a | 10.0.12 (Vorschlag, noch nicht installiert) | MIT | NuGet-Paket im Build | [Paket](https://www.nuget.org/packages/Microsoft.EntityFrameworkCore.Sqlite/10.0.12), [Lizenz](https://github.com/dotnet/efcore/blob/main/LICENSE.txt) | Codex, Vorbereitung AP09a; Gruppenfreigabe offen |
| Microsoft.EntityFrameworkCore.Design | Migrationserzeugung, AP09a; PrivateAssets | 10.0.12 (Vorschlag, noch nicht installiert) | MIT | nur Entwicklung | [Paket](https://www.nuget.org/packages/Microsoft.EntityFrameworkCore.Design/10.0.12), [Lizenz](https://github.com/dotnet/efcore/blob/main/LICENSE.txt) | Codex, Vorbereitung AP09a; Gruppenfreigabe offen |
| dotnet-ef | Lokales Werkzeug für Migrationserzeugung, AP09a | 10.0.12 (Vorschlag, noch nicht installiert) | MIT | nur Entwicklung | [Paket](https://www.nuget.org/packages/dotnet-ef/10.0.12), [Lizenz](https://github.com/dotnet/efcore/blob/main/LICENSE.txt) | Codex, Vorbereitung AP09a; Gruppenfreigabe offen |
...
- Die AP09a-Vorschläge wurden am 23.09.2026 anhand der oben verlinkten Paket- und Lizenzquellen geprüft. Sie sind keine Freigabe und ändern noch keine Projektdatei. Bei Umsetzung tatsächliche Paketauflösung einschliesslich transitiver SQLite-Komponenten und Lizenznachweise für das Abgabepaket prüfen und nachführen.
